...
public class EstrategiaTodas extends EstrategiaGeneral{ 
	...
	protected boolean elementosMatchThree(Entidad e,LinkedList<Entidad> matchVertical,LinkedList<Entidad> matchHorizontal) {
		...
		caminoDerecha(entidadActual,matchHorizontal); //Funcion recursiva para ver todos los caramelos a la derecha 
		caminoIzquierda(entidadActual,matchHorizontal); //Funcion recursiva para ver todos los caramelos a la izquierda
		caminoArriba(entidadActual,matchVertical); //Funcion recursiva para ver todos los caramelos de arriba
		caminoAbajo(entidadActual,matchVertical); //Funcion recursiva para ver todos los caramelos de abajo
