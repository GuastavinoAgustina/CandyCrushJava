...
public class Celda extends JLabel implements EntidadGrafica {
	...
	/**
	 * Permite cambiar la imagen asociada a la celda, a partir factuade una ruta que especifica la ubicación de la nueva imagen.
	...
	public void asociar_timer(CountdownTimer tiempo){
		tiempo.set_bounds(entidad_logica.get_columna()*size_label, entidad_logica.get_fila()*size_label, size_label, size_label);
		mi_ventana.mostrar_timer(tiempo);
	}
